...
let testSite = new Site({width: 100, height:100, smoothness: 4});
let main_disp = display_manager.add({ width: 52, height: 32, site: testSite, forceSquareRatio: true, fontSize: 24, target: screen, type: 'PlayScreen'});
